// src/components/InventoryGraph.jsx
...
const InventoryGraph = () => {
  ...
  return (
    <div className="w-full md:w-2/3 lg:w-1/2 p-4 bg-[#2E2A5C] shadow-md rounded-lg text-white">
      <div className="mb-4">
      ...
      {chartData.labels.length > 0 && (
        <div className="mt-4">
          <h2 className="text-lg font-semibold mb-4">Inventory Chart</h2>
